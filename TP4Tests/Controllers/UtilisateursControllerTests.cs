...
namespace TP4.Controllers.Tests
{
    ...
    public class UtilisateursControllerTests
    {
        ...
        [TestMethod]
        public void GetUtilisateurByEmaim_ExistingEmailPassed_ReturnsRightItem_AvecMoq()
        {
            // Arrange
            Utilisateur user = new Utilisateur
            {
        ...
        public void GetUtilisateurByEmail_UnknownEmailPassed_ReturnsNotFoundResult_AvecMoq()
        {
            ...
            var userController = new UtilisateursController(mockRepository.Object);
            // Act
            var actionResult = userController.GetUtilisateurByEmail("zhefzhfz").Result;
            // Assert
            Assert.IsInstanceOfType(actionResult.Result, typeof(NotFoundResult));
        }
        ...
        public void PutUtilisateurTest_AvecMoq()
        {
            ...
            Utilisateur userModifie = new Utilisateur
            {
                ...
                Prenom = "Lilley",
                Mobile = "0653930778",
                Mail = "clilleymd"+chiffre+"@last.fm",
                Pwd = "Toto12345678!",
                Rue = "Impasse des bergeronnettes",
                CodePostal = "74200",
                Ville = "Allinges",
